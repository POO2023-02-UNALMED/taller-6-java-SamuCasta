...
public class Vehiculo {
	...
	protected static int automovilesC = 0;
    protected static int camionetasC = 0;
    protected static int camionesC = 0;
    ...
    public static String vehiculosPorTipo() {
        return "Automoviles: " + automovilesC + "\n" + "Camionetas: "  + camionetasC + "\n" + "Camiones: " + camionesC;
    }
}
